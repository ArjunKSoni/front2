        ...
        <div className="row mb-4">
          <div className="col">
            <div className="form-outline">
              ...
              <label className="form-label"  for="form3Example1">Nitrogen</label>
            </div>
          </div>
          <div className="col">
            <div className="form-outline">
              <input type="number" required name='K' id="form3Example2" className="form-control" />
              <label className="form-label" for="form3Example2">Potassium</label>
            </div>
          </div>
        </div>
        ...
        <div className="row mb-4">
          <div className="col">
            <div className="form-outline">
              ...
              <label className="form-label"  for="form3Example1">Phosphorus</label>
            </div>
          </div>
          <div className="col">
            <div className="form-outline">
              <input type="number" required name='PH' id="form3Example2" className="form-control" />
              <label className="form-label" for="form3Example2">PH</label>
            </div>
          </div>
        </div>
